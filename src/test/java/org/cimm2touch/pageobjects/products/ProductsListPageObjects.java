...
public class ProductsListPageObjects extends PageFactoryInitializer{
	...
	public ProductsListPageObjects clickOnRemoveProduct(String productName) throws Exception {
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].click();",driver.findElement(By.xpath("//td[contains(text(),'"+productName+"')]/preceding-sibling::td/descendant::input[@title='Remove Product']")));
