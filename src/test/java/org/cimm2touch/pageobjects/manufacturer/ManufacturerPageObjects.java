...
public class ManufacturerPageObjects extends PageFactoryInitializer {
	...
	public ManufacturerPageObjects clickOnlisticon(String manufacturerName) throws InterruptedException {
		...
		WebElement wb = getDriver().findElement(By.xpath(
				"//td[contains(text(),'" + manufacturerName + "')]/following-sibling::td/a[@title='List Brand']"));
	...
	public boolean isBrandpresentHelp(String brandname) throws Exception {
		...
		try {
			...
			if (getDriver().findElement(By
					.xpath("//span[contains(text(),'Brand')]/ancestor::a/following-sibling::table/descendant::td[contains(text(),'"
							+ brandname + "')]"))
					.isDisplayed()) {
				return false;
			}
	...
	public ManufacturerPageObjects checkManufacturerAlreadyExist(String manufacturername) throws InterruptedException {
		waiting.explicitWaitVisibilityOfElement(
				By.xpath("//table[@id='listManufacturerForm:manufacturerTableId']/descendant::td[contains(text(),'"
						+ manufacturername + "')]"),
				15);
	...
	public ManufacturerPageObjects verifyUnsuccessfullMessage(String unsuccessfullMessageOfManufacturerSave)
			throws Exception {
	...
	public ManufacturerPageObjects verifySuccessMessageNewManuCreation(String manufacturerName) throws Exception {
		...
		Assert.assertEquals(verifySuccessMessageNewManuCreationLocator.getText().trim(),
				manufacturerName.substring(0, Math.min(manufacturerName.length(), 60))
						+ " Manufacturer saved Successfully");
		return this;
	}

	@Step("Enter manufacturer name {0} to delete")
	public ManufacturerPageObjects enterCreatedManufacturerToDelete(String createdManufacturerToDelete)
			throws Exception {
	...
	public ManufacturerPageObjects clickOnManufacturerName() throws Exception {
		...
		Assert.assertTrue(clickOnManufacturerNameLocator.isDisplayed(),
				"the text 'manufacturer name' is not displayed");
		return this;
	}
	...
	public ManufacturerPageObjects manufacturerSearchBeforeRemove(String manufacturername) throws Exception {
		...
		Assert.assertFalse(manufacturerSearchResultHelp(manufacturername),
				"Manufacturer is not available. Please create before remove");
		return this;
	...
	public ManufacturerPageObjects verifymessageAfterManufacturerCreate(String mfgName,
			String successMessageAfterCreate) throws InterruptedException {
	...
	public ManufacturerPageObjects addNewManufacture(String manufacturersName, String manufacturersCode,
			String manufacturerActiveStatus) throws Exception {
		Thread.sleep(5000);
	...
	public ManufacturerPageObjects verifyAfterSearchingForManufacturer(String manufacturersName) throws Exception {
		...
		Assert.assertTrue(getDriver()
				.findElement(By.xpath(
						"//span[@id='listManufacturerForm:noResults' and contains(.,'" + manufacturersName + "')]"))
				.isDisplayed(), "Manufacturer Results is Not Displaying");
		Assert.assertTrue(getDriver()
				.findElement(
						By.xpath("//form[@id='listManufacturerForm']//td[contains(.,'" + manufacturersName + "')]"))
				.isDisplayed());
		return this;
	}
	...
	public ManufacturerPageObjects addNewBrand(String brandName, String brandDesc, String brandActiveStatus,
			String brandURL) {
	...
	public ManufacturerPageObjects verifyErrorMessageOnSavingBrand(String errorMessage) throws Exception {
		...
		assertThat(getDriver().findElement(By.xpath("//span[@id='addBrandForm:hmsgBrandId']")).getText(),
	...
	public ManufacturerPageObjects verifyItemsDisplayedAfterClickingSortOrder() throws InterruptedException {
		...
		try {
			Assert.assertTrue(getDriver()
					.findElement(By.xpath("//select[contains(@id,'listManufacturerForm:sortLevelTableId:0:selOneId')]"))
					.isDisplayed());
			Assert.assertTrue(getDriver()
					.findElement(By.xpath("//select[contains(@id,'listManufacturerForm:sortLevelTableId:0:sortById')]"))
					.isDisplayed());
	...
	public ManufacturerPageObjects verifyManufacturersFormItemsAfterClickingResetButton(String manufacturerActiveStatus)
			throws Exception {
		Thread.sleep(5000);
	...
	public ManufacturerPageObjects verifyErrorMessageAfterSavingManufacturer(String errorMessage) throws Exception {
		...
		assertThat(getDriver().findElement(By.xpath("//span[@id='addNewManufacturerForm:hmsgId']")).getText(),
				containsString(errorMessage));
		return this;
	}
	...
	public ManufacturerPageObjects clickOnEditManufacturer(String manufacturersName) throws Exception {
		...
		getDriver()
				.findElement(By.xpath(
						"//td[contains(.,'" + manufacturersName + "')]//preceding::input[@title='Edit Manufacturer']"))
				.click();
		return this;
	}
	...
	public ManufacturerPageObjects clickOnEditBrand(String brandName) throws Exception {
		...
		getDriver().findElement(By.xpath("//table[contains(@id,'brandTableId')]//td[contains(.,'" + brandName
				+ "')]/..//div/input[@title='Edit Brand']")).click();
		return this;
	}
	...
	public ManufacturerPageObjects verifyAfterSearchingForBrand(String brandName) throws Exception {
		...
		Assert.assertTrue(getDriver()
				.findElement(By.xpath("//table[contains(@id,'brandTableId')]//td[contains(.,'" + brandName + "')]"))
				.isDisplayed(), "Brand Results is Displayed");
		return this;
	}
	...
	public ManufacturerPageObjects verifyMessageAfterDeletingBrand(String brandDelMessage) throws Exception {
		...
		assertThat(getDriver()
				.findElement(By
						.xpath("//form[@id='listManufacturerForm']//span[contains(@style,'green')and @id='listManufacturerForm:noResults']"))
				.getText(), containsString(brandDelMessage));
		return this;
	}
	...
	public ManufacturerPageObjects clickOnDeleteManufacturer() throws Exception {
		...
		getDriver()
				.findElement(By
						.xpath("//table[@id='listManufacturerForm:manufacturerTableId']//input[@title='Remove Manufacturer']"))
				.click();
		waiting.explicitWaitForAlert(10);
		tu.alertAccept();
		return this;
	...
	public ManufacturerPageObjects verifyMessageAfterDeletingManufacturer(String manuDelMessage) throws Exception {
		...
		assertThat(getDriver()
				.findElement(By
						.xpath("//form[@id='listManufacturerForm']//span[contains(@style,'green')and @id='listManufacturerForm:noResults']"))
				.getText(), containsString(manuDelMessage));
		return this;
	}
	...
	public ManufacturerPageObjects verifyAndRemoveBrand(String brandName) throws InterruptedException {
		...
		waiting.explicitWaitElementToBeClickable(
				By.xpath("//table[contains(@id,'brandTableId')]/descendant::td[contains(text(),'" + brandName
						+ "')]/preceding-sibling::td/descendant::input[@title='Remove Brand']"),
				50);
		WebElement wb = getDriver().findElement(By.xpath("//td[contains(text(),'" + brandName
				+ "')]/ancestor::td//preceding-sibling::td/descendant::input[@title='Remove Brand']"));
	...
	private boolean verifyBrandIsPresent(String brandName) {
		...
		try {
			if (getDriver().findElement(By.xpath(
					"//table[contains(@id,'brandTableId')]/descendant::td[contains(text(),'" + brandName + "')]"))
					.isDisplayed()) {
				return false;
			}
		} catch (NoSuchElementException e) {
	...
	public ManufacturerPageObjects removeAndVerifyManufacturer(String manufacturerName) throws InterruptedException {
		...
		WebElement wb = getDriver().findElement(
				By.xpath("//tbody[@id='listManufacturerForm:manufacturerTableId:tb']/descendant::td[contains(text(),'"
						+ manufacturerName
						+ "')]/preceding-sibling::td/descendant::input[@title='Remove Manufacturer']"));
	...
	public ManufacturerPageObjects clickOnListBrandItems(String brandName) {
		waiting.explicitWaitElementToBeClickable(By.xpath("//td[contains(text(),'" + brandName
				+ "')]/preceding-sibling::td/descendant::input[@title='List BrandItems']"), 20);
		getDriver().findElement(By.xpath("//td[contains(text(),'" + brandName
				+ "')]/preceding-sibling::td/descendant::input[@title='List BrandItems']")).click();
	...
	public ManufacturerPageObjects clickOnRequiredFieldNames(String fieldnames) throws InterruptedException {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			if (getDriver()
					.findElement(By.xpath("//tbody[contains(@id,'listManufacturerForm')]/tr/td/span[contains(text(),'"
							+ fields[i] + "')]/../../td[2]/*/*[1]"))
					.isSelected()) {

				getDriver().findElement(
						By.xpath("//tbody[contains(@id,'listManufacturerForm')]/tr/td/span[contains(text(),'"
								+ fields[i] + "')]/../../td[2]"));
			} else {
				getDriver().findElement(
						By.xpath("//tbody[contains(@id,'listManufacturerForm')]/tr/td/span[contains(text(),'"
	...
	public ManufacturerPageObjects verifyShowFieldsSettings() throws Exception {
		...
		utility.assertElementPresent(
				getDriver().findElement(By.xpath("//table/thead/tr/th/div[contains(text(),'Field Names')]")));
		utility.assertElementPresent(
				getDriver().findElement(By.xpath("//table/thead/tr/th/div[contains(text(),'Desktop View')]")));
		utility.assertElementPresent(
				getDriver().findElement(By.xpath("//table/thead/tr/th/div[contains(text(),'Tablet View')]")));
		utility.assertElementPresent(
				getDriver().findElement(By.xpath("//table/thead/tr/th/div[contains(text(),'Mobile View')]")));
		utility.assertElementPresent(
				getDriver().findElement(By.xpath("//table/thead/tr/th/div[contains(text(),'Display Names')]")));
		return this;
	}
	...
	public ManufacturerPageObjects verifyFields(String fieldnames) throws Exception {
		...
		for (int i = 0; i < fields.length; i++) {
			if (fields[i].equals("Manufacturer Logo")) {
				...
				utility.assertElementPresent(
						getDriver().findElement(By.xpath("//th/div[contains(text(),'Manufacturer Logo')]")));
			} else {
				utility.assertElementPresent(
						getDriver().findElement(By.xpath("//th/div/span[contains(text(),'" + fields[i] + "')]")));
			}
		}
		return this;
	}
