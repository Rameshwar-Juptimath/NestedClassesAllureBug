...
public class ManufacturerBrandPageObjects extends PageFactoryInitializer {
	...
	public  ManufacturerBrandPageObjects assrtManufacturerbrandtextLocator() throws Exception{
		...
		TestUtility.assertElementPresent(manufacturerbrandtextLocator);
		return this;
	}
	...
	public ManufacturerBrandPageObjects assrtasManufacturerbrandtextLocatornp() throws Exception{
		//Thread.sleep(2500);
		TestUtility.assertElementPresent(asmanufacturerbrandtextLocator);
		return this;
	}
	...
	public boolean manufacturerSearchResultHelp(String manufacturername) throws Exception
	{
		...
		try {
			if(driver.findElement(By.xpath("//form/table/tbody/tr[td["+count+"]='"+manufacturername+"']/td["+count+"]")).isDisplayed())
			{
			return false;
			}
			}
	...
	public ManufacturerBrandPageObjects clickOnlisticon() throws Exception {
		brandList.click();
		//Thread.sleep(4000);
		TestUtility.waitforElementPresent("//th/div[contains(text(),'Brand Name')]", 10);
		return this;
	}
	...
	public boolean isBrandpresentHelp(String brandname) throws Exception
	{
		...
		try {
			if(driver.findElement(By.xpath("//td[contains(text(),'"+brandname+"')]")).isDisplayed())
			{
			return false;
			}
			}
	...
	public ManufacturerBrandPageObjects clickOnaddnewbrandbutton() throws Exception {
		...
		//TestUtility.waitforElementPresent("//form/div[contains(text(),'Add New Brand')]", 10);
		Thread.sleep(4000);
	...
	public ManufacturerBrandPageObjects checkBrandSaveMessage(String brandsavemsg) throws Exception {
		TestUtility.waitforElementPresent("//*[@id='addBrandForm:saveMsgBrandId' and contains(text(),'"+brandsavemsg+"')]", 10);
