...
public class EditManufacturerPageObjects extends PageFactoryInitializer 
{
	...
	public EditManufacturerPageObjects verifyEditManufacturersAndBrandsPageItems() throws InterruptedException 
	{
		...
		Assert.assertTrue(editManu_ManufacturerActiveStatus.isDisplayed(),"Manufacturer Active Status Checkbox is not Displayed");
	...
	{
		Thread.sleep(5000);
		assertThat(driver.findElement(By.xpath("//span[@id='EditManufacturerForm:MName']")).getText(), containsString(errorMessage));
		return this;
	}
