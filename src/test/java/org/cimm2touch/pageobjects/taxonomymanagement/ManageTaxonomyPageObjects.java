...
public class ManageTaxonomyPageObjects extends PageFactoryInitializer
{
	...
	public ManageTaxonomyPageObjects verifyUserIsAblToViewTheHierarchyLevelsOfTheCategories(String categoryName) throws Exception 
	{
		...
		getDriver().findElement(By.xpath("//span[contains(text(),'"+categoryName+"')]//ancestor::tr[contains(@title,'"
	...
	public ManageTaxonomyPageObjects verifyDisplayNoOfItemsDropdown() throws Exception
	{
		...
		Thread.sleep(5000);
		List<WebElement> itemsDisplayed1= getDriver().findElements(By.xpath("(//div[@class='cimmAttributesColumn1']//tbody)[2]/tr"));
		...
		Thread.sleep(10000);
		List<WebElement> itemsDisplayed2 = getDriver().findElements(By.xpath("(//div[@class='cimmAttributesColumn1']//tbody)[2]/tr"));
		...
		Thread.sleep(10000);
		List<WebElement> itemsDisplayed3 = getDriver().findElements(By.xpath("(//div[@class='cimmAttributesColumn1']//tbody)[2]/tr"));
		...
		Thread.sleep(10000);
		List<WebElement> itemsDisplayed4 = getDriver().findElements(By.xpath("(//div[@class='cimmAttributesColumn1']//tbody)[2]/tr"));
		...
		Thread.sleep(10000);
		List<WebElement> itemsDisplayed5 = getDriver().findElements(By.xpath("(//div[@class='cimmAttributesColumn1']//tbody)[2]/tr"));
	...
	public ManageTaxonomyPageObjects clickOnDeleteAttributeButton(String attributeName) throws Exception
	{
		...
		tu.alertAccept();
		Thread.sleep(5000);
		Assert.assertTrue(getDriver().findElement(By.xpath("//span[contains(@style,'green') and contains(.,'Attribute Removed Successfully')]")).isDisplayed());
		return this;	
	}
