	...
	return this;
	 ...
	 @Step("This method is used verify the attribute GroupDesc In AttributeGroupsPage")
	  ...
	  @Step("click on add new Attribute Group ")
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].click();",addNewAttributeGroupsLocator);
		return this;
	   }
	    ...
	    ((JavascriptExecutor) driver).executeScript("arguments[0].click();",attributeGroupSaveButtonLocator); 
		return this;
		}
		 ...
		 ((JavascriptExecutor) driver).executeScript("arguments[0].click();",attributeGroupUpdateButtonLocator);
		 return this;
		}
		...
		return this;
		 ...
		 return this;
		  ...
		  return this;
		   ...
		   @Step("This method is used to remove the Attribute ")
			 public AttributeGroupsPageObjects clickOnRemoveUpdateAttributeGroup(String updateAttributeGroupName) throws InterruptedException {
			   Thread.sleep(3000);
			   WebElement wb=driver.findElement(By.xpath("(//td[contains(text(),'"+updateAttributeGroupName+"')]/preceding-sibling::td[@class='rich-table-cell']/div/input)[2]"));
			   wb.click();
			 return this;
			}
		   ...
		   @Step("This method is used to remove the Attribute ")
			 public AttributeGroupsPageObjects clickOnRemoveAttributeGroup(String attributeGroupName) throws InterruptedException {
			   Thread.sleep(3000);
			   WebElement wb=driver.findElement(By.xpath("(//td[contains(text(),'"+attributeGroupName+"')]/preceding-sibling::td[@class='rich-table-cell']/div/input)[2]"));
			   wb.click();
			 return this;
			}
		  ...
		  @Step("This method is used accept the alert popup")
			  ...
			  boolean t = TestUtility.getAlertText().trim().equals(removeAttributeGroupsAlertText.trim());
		   ...
		   public boolean assertUpdateAttributeGroupNameDeletion(String updateAttributeGroupName)
		   {
			   try
			   {
				   if(driver.findElement(By.xpath("updateAttributeGroupName")).isDisplayed())
				   {
					   return false;
				   }
			   }
		   ...
		   public boolean assertAttributeGroupNameDeletion(String attributeGroupName)
		   {
			   try
			   {
				   if(driver.findElement(By.xpath("attributeGroupName")).isDisplayed())
				   {
					   return false;
				   }
			   }
