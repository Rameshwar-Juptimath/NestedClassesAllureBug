...
public class SubsetPageObjects extends PageFactoryInitializer {
	...
	public void FluentWaitForVisibilityOfElement(int TotalTimeInSeconds, int PollingTimeInMilliSeconds,
			WebElement element) {
	...
	public SubsetPageObjects addNewSubset(String addNewSubset, String subsetName, String subsetDescription,
			String purpose, String status, String successmsg) throws Exception {
	...
	public SubsetPageObjects subsetDelete(String subsetName) throws Exception {
		...
		WebElement verifySubsetNameLocator = getDriver()
				.findElement(By.xpath("//span[contains(text(),'" + subsetName + "')]"));
		if (subsetName.trim().equals(verifySubsetNameLocator.getText().trim())) {
			String substId = getsubsetId();
			clickOnSpecificDeleteButton(1);
			tu.alertAccept();
			Thread.sleep(2000);
			Assert.assertEquals(subsetRemoveMessage.getText(),
					"Subset - : '" + subsetName + "'with Subset Id -'" + substId + "' removed Successfully");
		}
		return this;
	}
	...
	public HomePageObjects searchSubsetInvlaidData(String subsetName, String subsetErrorMessage)
			throws InterruptedException {
		serchSubset(subsetName);
		Thread.sleep(1500);

		Assert.assertEquals(getDriver().findElement(By.xpath("//span[@id='subsetForm:noResults']")).getText().trim(),
				subsetErrorMessage.trim());
	...
	public SubsetPageObjects clickOnSpecificCatelogBuilderButton(int specificCatlogBuilderButton)
			throws InterruptedException {
		Thread.sleep(1500);
	...
	public SubsetPageObjects updateSubset(String newSubsetDescription, String subsetsucmsg)
			throws InterruptedException {
		Thread.sleep(2000);
	...
	public SubsetPageObjects clickOnSpecificManufacturer(String getmanufacturername) {
		...
		getDriver()
				.findElement(
						By.xpath("//td[contains(text(),'" + getmanufacturername + "')]/preceding-sibling::td/label"))
				.click();
		return this;
	}
	...
	public SubsetPageObjects clickOnSpecificDeleteButton(String subsetName) {
		...
		getDriver().findElement(By.xpath("//span[contains(text(),'" + subsetName
				+ "')]/ancestor::td/preceding-sibling::td/input[@title='Remove Subset Item']")).click();
		return this;
	}
	...
	public SubsetPageObjects verifySubsetPresent(String subsetname) throws Exception {
		Assert.assertFalse(assertVerifySubsetPresent(subsetname),
				"subset:---" + subsetname + "is already present, please remove to create it again.");
		return this;
	...
	private boolean assertVerifySubsetPresent(String subsetname) throws Exception {
		...
		try {
			if (getDriver().findElement(By
					.xpath(" //tbody[@id='subsetForm:subsetTableId:tb']/descendant::span[text()='" + subsetname + "']"))
					.isDisplayed()) {
				return true;
			}
		} catch (NoSuchElementException e) {
	...
	public SubsetPageObjects verifySubsetBeforeRemove(String subsetName) throws Exception {
		Assert.assertFalse(assertVerifySubsetPresent(subsetName),
				"subset is not available, Please create before remove");
		return this;
	}
	...
	public SubsetPageObjects verifyAfterSearchingForSubset(String subsetName) throws Exception {
		...
		Assert.assertTrue(getDriver()
				.findElement(
						By.xpath("//table[@id='subsetForm:subsetTableId']//span[contains(.,'" + subsetName + "')]"))
				.isDisplayed());
		return this;
	}
	...
	public SubsetPageObjects clickOnEditSubset(String subsetName) throws Exception {
		waiting.explicitWaitVisibilityOfElement(
				By.xpath("//span[text()='" + subsetName + "']/ancestor::tr/descendant::input[@title='Edit Subset']"),
				45);
		getDriver()
				.findElement(By.xpath(
						"//span[text()='" + subsetName + "']/ancestor::tr/descendant::input[@title='Edit Subset']"))
				.click();
		return this;
	}
	...
	public String verifyandDeleteSubset(String subsetName) throws Exception {
		...
		WebElement wb = getDriver().findElement(By.xpath("//span[contains(text(),'" + subsetName
				+ "')]/ancestor::td//preceding-sibling::td/descendant::input[@value='Remove']"));

		Assert.assertEquals(
				getDriver().findElement(By.xpath("//span[contains(text(),'" + subsetName + "')]")).getText(),
				subsetName, "" + subsetName + " is not available");

		String subsetId = getDriver()
				.findElement(By
						.xpath("//span[contains(text(),'" + subsetName + "')]/ancestor::td//preceding-sibling::td[1]"))
				.getText();
	...
	public SubsetPageObjects verifySuccessMessageForDeletionOfSubset(String subsetName, String subsetId)
			throws InterruptedException {

		Thread.sleep(3000);
		Assert.assertEquals(succesfulMessageForDeleteSubset.getText(),
				"Subset - : '" + subsetName + "'with Subset Id -'" + subsetId + "' removed Successfully");
	...
	public SubsetPageObjects createSubset(String subsetName, String subsetDescription) throws InterruptedException {
		...
		clickOnAddNewSubset();
		enterTheSubsetName(subsetName).enterTheSubsetDescription(subsetDescription).clickOnSaveLink();
		return this;
	...
	@FindAll(value = { @FindBy(xpath = "//form[@id='EditSubsetForm']/descendant::div[@class='cimm_formLabel']") })
	private List<WebElement> allEditSubsetFieldsLocator;

	@Step("selecting {0} number of records to display.")
	public SubsetPageObjects selectNumberOfRecordsToDisplayInThePage(String selectNumberOfRecordsToDisplay)
			throws InterruptedException {
	...
	public SubsetPageObjects createSubsetWithoutMandatoryField(String subsetDescription) throws InterruptedException {
		enterTheSubsetDescription(subsetDescription).clickOnSaveLink();
		return this;
	}
