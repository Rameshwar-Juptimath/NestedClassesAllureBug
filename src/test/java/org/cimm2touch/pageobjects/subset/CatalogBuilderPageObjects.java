...
public class CatalogBuilderPageObjects extends PageFactoryInitializer {
	...
	public CatalogBuilderPageObjects verifyCatalogBuilderPageItems() throws Exception {
		...
		Assert.assertTrue(CBV_Available_AddManufacurer.isDisplayed(),
				"Left Side Bar -> Add New Manufacturer is Absent under 'Available' Tab");
		Assert.assertTrue(CBV_Available_AddBrand.isDisplayed(),
				"Left Side Bar -> Add New Brand is Absent under 'Available' Tab");
	...
	public CatalogBuilderPageObjects addManufacturerAndBrand(String manufacturerName, String brandName)
			throws Exception {
		Thread.sleep(5000);
		...
		getDriver().findElement(By.xpath("//td[contains(@id,'subsetList:MnfListTabId') and (text()='" + manufacturerName
		...
		getDriver().findElement(By.xpath("//td[contains(@id,'subsetList:brandTableId') and (text()='" + brandName
				+ "')]/preceding-sibling::td/label")).click();
		return this;
	}
	...
	@FindAll(value = {
			@FindBy(xpath = "//thead[@class='rich-table-thead']/descendant::th[@class='rich-table-subheadercell']/span") })
	...
	public CatalogBuilderPageObjects verifyBrandNameUnderSelectedTab(String brandName) {
		WebElement brand = getDriver().findElement(
				By.xpath("//td[contains(text(),'BRAND')]/preceding-sibling::td[text()='" + brandName + "']"));
	...
	public CatalogBuilderPageObjects verifyManufacturerNameUnderSelectedTab(String manufacturerName) {
		...
		WebElement manufacturer = getDriver().findElement(By.xpath(
				"//td[contains(text(),'MANUFACTURER')]/preceding-sibling::td[text()='" + manufacturerName + "']"));
	...
	public CatalogBuilderPageObjects verifyManufacturerCountAndBrandCount(String brandCount, String manufacturerCount,
			String messageOfCount) {

		WebElement countOfBrandAndmanufacture = getDriver().findElement(By.xpath("//span[contains(text(),'" + brandCount
				+ " Brand(s) , " + manufacturerCount + " Manufacturer Saved In Rules')]"));
	...
	public CatalogBuilderPageObjects verifySuccessMessageForDeletionOfBrand(String brandName)
		...
		Assert.assertEquals(deleteBrandMessageLocator.getText(),
				"Entity With Name - : '" + brandName + "' removed Successfully.");
		return this;
	}
	...
	public CatalogBuilderPageObjects verifySuccessMessageForDeletionOfManufacturer(String manufacturerName)
			throws InterruptedException {
		...
		Assert.assertEquals(deleteManufacturerMessageLocator.getText(),
				"Entity With Name - : '" + manufacturerName + "' removed Successfully.");
		return this;
	}
	...
	public CatalogBuilderPageObjects verifySuccessMsgAfterAdditionOfTem(String msgAfterAdditionOfItem)
			throws InterruptedException {
		Thread.sleep(3000);
	...
	public CatalogBuilderPageObjects verifyItemUnderAllItemTab(String partNumber,
			String msgUnderAllTabAfterAdditionOfItem) {
