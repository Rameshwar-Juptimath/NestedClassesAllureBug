...
public class EditItemsPageObjects extends PageFactoryInitializer {
	...
	public EditItemsPageObjects verifyContentunderAvailableLinkedItems() {
		...
		Assert.assertTrue(AvailableLinkedItemsMPNLocator.isDisplayed(),
				"Manufacturer Part Number label is not diaplayed");
		Assert.assertTrue(AvailableLinkedItemsItemStatusLocator.isDisplayed(), "Item Status label is not diaplayed");
		Assert.assertTrue(AvailableLinkedItemsDisplayOnlineLocator.isDisplayed(),
				"Display Online label is not diaplayed");
		Assert.assertTrue(AvailableLinkedItemsLinkeditemsQTYLocator.isDisplayed(),
				"Linked Items Qty Intervals label is not diaplayed");
		return this;
	}
	...
	public EditItemsPageObjects verifyAttributesTabFileds() throws InterruptedException {
		...
		Assert.assertTrue(AttributeValueGroupLocator.isDisplayed(),
				"Attribute value group text field is not diaplayed");
		return this;
	}
	...
	public EditItemsPageObjects verifyLanguageOptions(String languageCode) throws InterruptedException {
		...
		Thread.sleep(2000);
		Assert.assertTrue(languageOptionValueLocator.getAttribute("selected").contains(languageCode),
