...
public class AddNewItemPageObjects extends PageFactoryInitializer{
	...
	public AddNewItemPageObjects selectAndVerifyItemStatusOptions(String[] itemStatusOptions,String [] valuesAssignedToEachOption) {
		...
		Assert.assertEquals(((JavascriptExecutor) driver).executeScript("return document.getElementById('"+idOfSelect+"').value;"), valuesAssignedToEachOption[i]);
	...
	public AddNewItemPageObjects verifyCheckboxes(String checkboxes) throws Exception {
		...
		case "Display Online":
			Thread.sleep(1500);
			((JavascriptExecutor) driver).executeScript("arguments[0].click();",displayOnlineCheckboxLocator);
		...
		case "Drop Ship": 
			Thread.sleep(1200);
			((JavascriptExecutor) driver).executeScript("arguments[0].click();",dropShipCheckboxLocator);
		...
		case "Print": 
			Thread.sleep(1200);
			((JavascriptExecutor) driver).executeScript("arguments[0].click();",printCheckboxLocator);
	 ...
	 public AddNewItemPageObjects clickOnManufacturerDropdown() throws InterruptedException {
			...
			((JavascriptExecutor)driver).executeScript("arguments[0].click();",manufacturerDropDownArrowLocator);
			return this;
		}
	 ...
	 public AddNewItemPageObjects clickOnBrandDropdown() throws InterruptedException {
		 ...
		 Thread.sleep(500);
		 ((JavascriptExecutor)driver).executeScript("arguments[0].click();",brandDropDownLocator);
