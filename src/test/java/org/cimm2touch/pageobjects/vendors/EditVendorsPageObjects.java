...
public class EditVendorsPageObjects extends PageFactoryInitializer
{
	...
	{
		Thread.sleep(5000);
		Assert.assertTrue(editVendors_VendorName.isDisplayed(), "Vendor Name Field is not Displayed in Edit Vendors Page.");
		Assert.assertTrue(editVendors_ShortName.isDisplayed(), "Short Name Field is not Displayed in Edit Vendors Page.");
		...
		Assert.assertTrue(editVendors_SubsetName.isDisplayed(), "Subset Name Field is not Displayed in Edit Vendors Page.");
		...
		Assert.assertTrue(editVendors_UpdateVendor.isDisplayed(), "Update Vendor Button is not Displayed in Edit Vendors Page.");
		return this;
	}
	...
	public EditVendorsPageObjects verifyMessageOnUpdatingVendorsWithoutName(String vendorNameMessage) throws Exception 
	{
		...
		Thread.sleep(5000);
		assertThat(driver.findElement(By.xpath("//input[@id='editSupplierForm:supplierName']/following-sibling::span[contains(@style,'red')]")).getText(), 
				containsString(vendorNameMessage));
		return this;
	}

	@Step("To Verify Message after Updating Vendor without Short Name")
	public EditVendorsPageObjects verifyMessageOnUpdatingVendorsWithoutShortName(String shortNameMessage) throws Exception 
	{
		editVendors_ShortName.clear();
		editVendors_UpdateVendor.click();
		Thread.sleep(5000);
		assertThat(driver.findElement(By.xpath("//input[@id='editSupplierForm:shortName']/following-sibling::span[contains(@style,'red')]")).getText(), 
				containsString(shortNameMessage));
		return this;
	}

	@Step("To Verify Message after Updating Vendor without Address1")
	public EditVendorsPageObjects verifyMessageOnUpdatingVendorsWithoutAddress1(String address1Message) throws Exception 
	{
		editVendors_Address1.clear();
		editVendors_UpdateVendor.click();
		Thread.sleep(5000);
		assertThat(driver.findElement(By.xpath("//textarea[@id='editSupplierForm:address1']/following-sibling::span[contains(@style,'red')]")).getText(), 
	...
	public EditVendorsPageObjects verifyMessageOnUpdatingVendorsWithoutEmail(String emailMessage) throws Exception
	{
		...
		editVendors_UpdateVendor.click();
		Thread.sleep(5000);
		assertThat(driver.findElement(By.xpath("//input[@id='editSupplierForm:email']/following-sibling::span[contains(@style,'red')]")).getText(), 
	...
	public EditVendorsPageObjects switchToNewlyOpenedWindowAndVerifyVendorName(String vendorsName) throws Exception
	{
		...
		Thread.sleep(2000);
		Assert.assertTrue(driver.findElement(By.xpath("//div[@class='tableLayout']/table/tbody/tr/descendant::tr/td[contains(.,'"+vendorsName+"')]")).isDisplayed());
		Thread.sleep(5000);
		TestUtility.switchBackToFirstWindow();
		TestUtility.switchToRecentWindow(0);
		return this;
	}
