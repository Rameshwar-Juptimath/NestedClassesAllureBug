...
public class VendorsPageObjects extends PageFactoryInitializer {
	...
	public VendorsPageObjects addNewVendor(String vendorsName, String shortName, String address1, String city,
			String state, String zip, String country, String email, String subset, String url, String taxID,
			String status) {
		...
		getDriver().findElement(By.xpath("//select[@id='addNewSupplierForm:country']/option[text()='" + country + "']"))
				.click();
		addVendor_Email.clear();
		addVendor_Email.sendKeys(email);
		getDriver().findElement(By.xpath("//select[@id='addNewSupplierForm:subsetId']/option[text()='" + subset + "']"))
				.click();
		addVendor_URL.clear();
		...
		getDriver().findElement(By.xpath("//select[@id='addNewSupplierForm:status']/option[text()='" + status + "']"))
				.click();
		return this;
	}
	...
	public VendorsPageObjects verifyMessageAfterSavingVendorWithoutVendorName(String nameErrorMessage)
			throws Exception {
		Thread.sleep(5000);

		Assert.assertTrue(getDriver()
				.findElement(By
						.xpath("//input[@id='addNewSupplierForm:supplierName']/following-sibling::span[contains(@style,'red')]"))
				.isDisplayed());
		assertThat(getDriver()
				.findElement(By
						.xpath("//input[@id='addNewSupplierForm:supplierName']/following-sibling::span[contains(@style,'red')]"))
				.getText(), containsString(nameErrorMessage));
		return this;
	}
	...
	public VendorsPageObjects verifyMessageAfterSavingVendorWithoutShortName(String shortNameErrorMessage) {
		...
		assertThat(getDriver()
				.findElement(By
						.xpath("//input[@id='addNewSupplierForm:shortName']/following-sibling::span[contains(@style,'red')]"))
				.getText(), containsString(shortNameErrorMessage));
		return this;
	}
	...
	public VendorsPageObjects verifyMessageAfterSavingVendorWithoutAddress1(String address1ErrorMessage) {
		...
		assertThat(getDriver()
				.findElement(By
						.xpath("//textarea[@id='addNewSupplierForm:address1']/following-sibling::span[contains(@style,'red')]"))
				.getText(), containsString(address1ErrorMessage));
		return this;
	}
	...
	public VendorsPageObjects verifyMessageAfterSavingVendorWithoutEmail(String emailErrorMessage) {
		...
		assertThat(getDriver()
				.findElement(By
						.xpath("//input[@id='addNewSupplierForm:email']/following-sibling::span[contains(@style,'red')]"))
				.getText(), containsString(emailErrorMessage));
		return this;
	}
	...
	public VendorsPageObjects verifySearchResultForVendors(String vendorsName) throws Exception {
		...
		Assert.assertTrue(getDriver()
				.findElement(By.xpath("//table[@id='listSupplierForm:listSupplierTableId']/descendant::td[contains(.,'"
						+ vendorsName + "')]"))
				.isDisplayed());
		return this;
	}
	...
	public VendorsPageObjects clickOnEditVendors(String vendorsName) {
		...
		getDriver()
				.findElement(By.xpath("//table[@id='listSupplierForm:listSupplierTableId']/descendant::td[contains(.,'"
						+ vendorsName + "')]/preceding::input[@title='Edit Vendor']"))
				.click();
		return this;
	}
	...
	public VendorsPageObjects verifyDisplayNoOfItemsDropdown() throws Exception {
		...
		Thread.sleep(5000);
		Assert.assertEquals(
				new Select(getDriver().findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select")))
	...
	public boolean vendorSearchResultHelp(String vendorName) throws Exception {
		...
		try {
			if (getDriver().findElement(By
					.xpath("//tbody[@id='listSupplierForm:listSupplierTableId:tb']/tr/descendant::td[contains(text(),'"
							+ vendorName + "')]"))
					.isDisplayed()) {
				return false;
			}
	...
	public VendorsPageObjects verifyAndRemoveVendore(String vendorName) throws InterruptedException {
		...
		waiting.explicitWaitVisibilityOfElement(
				By.xpath("//span[contains(text(),'Vendor Name')]/ancestor::table/descendant::td[contains(text(),'"
						+ vendorName + "')]"),
				30);
		Assert.assertTrue(getDriver().findElement(
				By.xpath("//span[contains(text(),'Vendor Name')]/ancestor::table/descendant::td[contains(text(),'"
						+ vendorName + "')]"))
				.isDisplayed(), "Vendor :" + vendorName + " is not available.");
		WebElement wb = getDriver().findElement(
				By.xpath("//span[contains(text(),'Vendor Name')]/ancestor::table/descendant::td[contains(text(),'"
						+ vendorName + "')]/preceding-sibling::td/descendant::input[@title='Remove Vendor']"));
	...
	public VendorsPageObjects verifySuccessMessageForRemove(String vendorName) throws InterruptedException {
		...
		Assert.assertEquals(successfulMessageRemoveVendorLocator.getText(),
				"Vendor : '" + vendorName + "' removed Successfully");
	...
	public VendorsPageObjects verifyVendorsPageWithRequiredFields(String requiredfields) throws InterruptedException {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			Assert.assertTrue(getDriver()
					.findElement(
							By.xpath("//thead[@class='rich-table-thead']/descendant::*[text()='" + fields[i] + "']"))
					.isDisplayed());
		}
