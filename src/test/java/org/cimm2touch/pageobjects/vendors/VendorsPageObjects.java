...
public class VendorsPageObjects extends PageFactoryInitializer
{
	...
	{
		Waiting.FluentWaitForVisibilityOfElement(10, 500, vendors_SearchBox);
			...
			String zip, String country, String email, String subset, String url, String taxID, String status) 
	{
		...
		driver.findElement(By.xpath("//select[@id='addNewSupplierForm:country']/option[text()='"+country+"']")).click();
		addVendor_Email.clear();
		addVendor_Email.sendKeys(email);
		driver.findElement(By.xpath("//select[@id='addNewSupplierForm:subsetId']/option[text()='"+subset+"']")).click();
		addVendor_URL.clear();
		addVendor_URL.sendKeys(url);
		addVendor_TaxID.clear();
		addVendor_TaxID.sendKeys(taxID);
		driver.findElement(By.xpath("//select[@id='addNewSupplierForm:status']/option[text()='"+status+"']")).click();
		return this;
	}
	...
	{
		Waiting.FluentWaitForVisibilityOfElement(10, 500, addVendor_SaveMessage);
	...
	{
		Thread.sleep(5000);
		Assert.assertTrue(driver.findElement(By.xpath("//input[@id='addNewSupplierForm:supplierName']/following-sibling::span[contains(@style,'red')]")).isDisplayed());
		assertThat(driver.findElement(By.xpath("//input[@id='addNewSupplierForm:supplierName']/following-sibling::span[contains(@style,'red')]")).getText(),
	...
	{
		assertThat(driver.findElement(By.xpath("//input[@id='addNewSupplierForm:shortName']/following-sibling::span[contains(@style,'red')]")).getText(),
	...
	{
		assertThat(driver.findElement(By.xpath("//textarea[@id='addNewSupplierForm:address1']/following-sibling::span[contains(@style,'red')]")).getText(),
	...
	{
		assertThat(driver.findElement(By.xpath("//input[@id='addNewSupplierForm:email']/following-sibling::span[contains(@style,'red')]")).getText(),
	...
	{
		Thread.sleep(5000);
		Assert.assertTrue(driver.findElement(By.xpath("//table[@id='listSupplierForm:listSupplierTableId']/descendant::td[contains(.,'"+vendorsName+"')]")).isDisplayed());	
		return this;
	}
	...
	{
		driver.findElement(By.xpath("//table[@id='listSupplierForm:listSupplierTableId']/descendant::td[contains(.,'"+vendorsName+"')]/preceding::input[@title='Edit Vendor']")).click();
		return this;
	}
	...
	{
		((JavascriptExecutor)driver).executeScript("arguments[0].click();",pagination_NextButton);
		Thread.sleep(5000);
		int currentPageNumber1 =  Integer.parseInt(pagination_CurrentPageCount.getText());
	...
	{
		driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select/option[@value='25']")).click();
		Thread.sleep(5000);
		Assert.assertEquals(new Select(driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select"))).getFirstSelectedOption().getText(), "25");
		Thread.sleep(5000);

		driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select/option[@value='50']")).click();
		Thread.sleep(5000);
		Assert.assertEquals(new Select(driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select"))).getFirstSelectedOption().getText(), "50");
		Thread.sleep(5000);

		driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select/option[@value='75']")).click();
		Thread.sleep(5000);
		Assert.assertEquals(new Select(driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select"))).getFirstSelectedOption().getText(), "75");
		Thread.sleep(5000);

		driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select/option[@value='100']")).click();
		Thread.sleep(5000);
		Assert.assertEquals(new Select(driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select"))).getFirstSelectedOption().getText(), "100");
		Thread.sleep(5000);

		driver.findElement(By.xpath("//div[@class='centerPanelRightIcons ']/select/option[@value='10']")).click();
		Thread.sleep(5000);
